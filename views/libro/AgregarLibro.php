...
<div class="span9">
    ...
    <form  name="nuevo" id="nuevo" class="form-horizontal" action="index.php?c=libro&a=agregalibro" method="POST" enctype="multipart/form-data" >
		...
		<h4>Ingrese datos del Libro </h4>
			...
			<label class="control-label" for="inputFname1">Nombre de Libro<sup>*</sup></label>
			<div class="controls">
                            <input type="text" id="nombre" name="nombre" placeholder="nombre" >
			</div>
		 </div>
		<div class="control-group">
			<label class="control-label" for="inputFname1">Resumen <sup>*</sup></label>
			<div class="controls">
                            <textarea type="text" rows="4"  id="resumen" name="resumen" placeholder="resumen"></textarea>
			</div>
		 </div>

		 <div class="control-group">
			<label class="control-label" for="inputLnam">ISBN<sup>*</sup></label>
			<div class="controls">
		...
		<div class="controls">
                    <input type="text" id="nombreAutor"  name="nombreAutor" placeholder="nombreAutor">
		</div>
	  </div>
                	
                
                	<div class="control-group">
		<label class="control-label" for="input_email">Nacionalidad del Autor<sup>*</sup></label>
		<div class="controls">
