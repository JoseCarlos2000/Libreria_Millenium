...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Busqueda de Usuario</li>
            ...
            <form id="nuevo" name="nuevo" action="index.php?c=cliente&a=BusqClientexApellido" method="POST">
	  <div>
            <h3> Busqueda de Usuario</h3>
            <tr><center><td>Apellido<td><input  type="text" id="apellido" name="apellido">
	...
	<div class="control-group">
             ...
             <table class="table table-sm table-dark">
                <tr><th>Cuenta<th>Contraseña<th>Apellidos<th>Nombres<th>Localidad<th>Telefono<th>Correo<th>Opcion<th>Opcion
                        <?php
                           if (isset($_REQUEST["btnBusc"]))
                         {
                            foreach ($data["clientes"] as $dato)
                            {
                              ...
                              echo "<tr><td>".$dato["cuenta"]."<td>".$dato["contraseña"]."<td>".$dato["apellidos"]."<td>".$dato["nombres"]."<td>".$dato["localidad"]."<td>".$dato["telefono"]."<td>".$dato["correo"]."";
                          
                              ?>
                    <td><a  href="index.php?c=cliente&a=datosusuario&id=<?=$dato["cuenta"]?>" class="btn btn-info">Elegir</a><td><a href="index.php?c=cliente&a=eliminausuario&id=<?=$dato["cuenta"]?>" class="btn btn-info">Eliminar</a>
                        <?php
                           }
                         }
                        ?>
